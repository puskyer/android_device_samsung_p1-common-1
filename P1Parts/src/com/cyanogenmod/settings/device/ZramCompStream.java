...
public class ZramCompStream implements OnPreferenceChangeListener {

    private static final String FILE = "/data/misc/zram/max_comp_streams";
    ...
    public static void restore(Context context) {
        ...
        Utils.writeValue(FILE, sharedPrefs.getString(DeviceSettings.KEY_ZRAM_COMP_STREAM, "1"));
    }
