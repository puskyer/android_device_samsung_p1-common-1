...
public class ZramNumDevice implements OnPreferenceChangeListener {
    ...
    public static void restore(Context context) {
        ...
        Utils.writeValue(FILE, sharedPrefs.getString(DeviceSettings.KEY_ZRAM_NUM_DEVICE, "1"));
    }
    ...
    public static void updateFile(int newValue) {
        Utils.writeValue(FILE, String.valueOf(newValue));
    }
