...
public class ZramCompAlgorithm implements OnPreferenceChangeListener {

    private static final String FILE = "/data/misc/zram/comp_algorithm";
    ...
    public static void restore(Context context) {
        ...
        Utils.writeValue(FILE, sharedPrefs.getString(DeviceSettings.KEY_ZRAM_COMP_ALGORITHM, "lzo"));
    }
